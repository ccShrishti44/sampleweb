...
import { COLLEGES, STREAM_OPTIONS } from "@/lib/data";
...
export default function Colleges() {
  ...
  const presetStream = searchParams.get("stream");
  const initialStream =
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_18%,#ffffff_100%)] pb-24">
      <section className="border-b border-border bg-[linear-gradient(135deg,rgba(15,23,42,1),rgba(30,41,59,0.96),rgba(37,99,235,0.88))] text-white">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 py-20 md:py-24">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-white/80">
                College Directory
              </span>
              <h1 className="mt-6 max-w-4xl font-display text-4xl font-bold tracking-tight md:text-6xl">
                Compare colleges with the detail students actually need.
              </h1>
              <p className="mt-5 max-w-3xl text-base leading-7 text-white/75 md:text-lg">
                Review programmes, exams accepted, fee context, location, and
                campus highlights in a cleaner format. Each profile now leads to
                a dedicated college slug page for deeper evaluation.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {[
                ...
                ["Profile depth", "Structured facts and highlights"],
              ].map(([label, value]) => (
