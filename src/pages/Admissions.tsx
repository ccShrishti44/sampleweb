...
import { EXAM_TIMELINE, DEADLINE_EVENTS, DeadlineEvent, DeadlineEventType } from '@/lib/data';
...
export default function Admissions() {
  ...
  useEffect(() => {
    if (location.hash === "#deadline-calendar") {
      setTimeout(() => {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-primary py-20 text-primary-foreground">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-display font-bold mb-6">Admissions 2026 Guide</h1>
          <p className="text-lg opacity-90 max-w-2xl mx-auto">
            Your complete roadmap to securing a seat in top Indian universities. Navigate the complex admission process with ease.
          </p>
        </div>
      </div>
